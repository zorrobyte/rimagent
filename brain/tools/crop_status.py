...
@tool("crop_status",
      ...
      {"def_name": "ThingDef to check (default Plant_Rice; pass empty string to check all plants in growing zones)"})
    ...
    for zdef in plant_defs:
        ...
        for p in sample:
            ...
            try:
                ...
                sown = ctx.bridge.call("engine.get", path=f"Thing:{pid}.sown")
                if sown:
                    sown_count += 1
            except Exception:
                growths.append(0.0)
